...
class TestActionMetadata:
    ...
    def test_from_dict_basic(self):
        ...
        from tascer.action_registry import ActionCategory, ActionMetadata, RiskLevel
    ...
    def test_from_dict_mutation_with_checkpoint(self):
        ...
        from tascer.action_registry import ActionMetadata
...
class TestActionRegistry:
    ...
    def test_list_observations(self):
        ...
        from tascer.action_registry import ActionCategory, get_registry
