...
class RecallResult:
    ...
    present_moment_id: int | None = None
    query: str = ""
...
class Supe:
    ...
    def __init__(
        ...
        # Sensory system
        from .sensory import BrowserOrgan, SensorySystem
    ...
    async def _run_learner(self, awareness_card_id: int) -> None:
        ...
        try:
            ...
            await learner.learn(awareness_card)
    ...
    async def step(
        self,
        sensory_kwargs: dict[str, dict[str, Any]] | None = None,
    ) -> Moment:
